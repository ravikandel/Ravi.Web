...
export class EnvironmentApiRequestFactory extends BaseAPIRequestFactory {
    ...
    /**
     */
    public async getEnvironment(_options?: Configuration): Promise<RequestContext> {
...
export class EnvironmentApiResponseProcessor {
     ...
     */
     public async getEnvironmentWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
