...
[assembly: InternalsVisibleTo("Ravi.Web.Client.Test")]
...
namespace Ravi.Web.Client.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is HealthStatusEnumV1 healthStatusEnumV1)
                return HealthStatusEnumV1ValueConverter.ToJsonValue(healthStatusEnumV1);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://localhost:8090/api";
